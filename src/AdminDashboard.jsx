  ...
  return (
    <div className="w-full h-fit px-5">
      ...
      <div className="flex gap-5">
        {data.map((item, index) => (
          <div key={item.title} className="h-[20vh] w-1/4 transition-all duration-300 ease-in bg-[#D6EFD8] cursor-pointer hover:bg-[#43A344] hover:text-white rounded-lg p-4 flex gap-5 items-center justify-center">
      ...
      <section className="flex gap-5 ">
        <div className="w-1/2 my-10 py-20 rounded-lg bg-[#D6EFD8]">
          <PieActiveArc />
        </div>
        <div className="w-1/2 my-10 py-20 rounded-lg bg-[#D6EFD8]">
          <ChartsOverview />
