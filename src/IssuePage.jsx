...
import { Camera, Upload, Send, AlertCircle, Calendar, Home, Phone, Mail, User } from 'lucide-react';
    ...
    {/* <ChatBot /> */}
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-10 mt-20">
          <h1 className="text-4xl font-bold text-green-800 mb-4">How Can We Help You?</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            We're here to assist you with any issues or concerns. Please fill out the form below and we'll get back to you as soon as possible.
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                >
                  ...
                  <span className="text-gray-600">Drop your images here or click to upload</span>
                  <span className="text-sm text-gray-500">(Maximum 5 images, up to 5MB each)</span>
                </label>
                
                {images.length > 0 && (
                  <div className="mt-4 flex flex-wrap gap-2">
                    {images.map((image, index) => (
                      <div key={index} className="bg-green-50 px-3 py-1 rounded-full text-sm text-green-700">
                        {image}
                      </div>
                    ))}
                  </div>
